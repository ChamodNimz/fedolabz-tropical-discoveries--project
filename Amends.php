...
function idIncrement($con){
  ...
  if($_POST){
    ...
    //update voucherh table status amended
    $query="update voucherh set status = 'amended' where voucherNo = '$voucherNo' and status = 'pending' ";
    if(!mysqli_query($connection,$query)){
      echo "Error updating status";
    }
    
  //voucher header injection
  $query="INSERT INTO `voucherh`(`ID_H`, `voucherNo`, `voucherDate`, `hotelName`, `typeName`, `status`, `AmendCount`, `conformationCode`, `receivedFrom`, `receivedCode`, `nationalty`, `extra`, `specialRequests`, `guestName`) VALUES (
  '$id_h',
  '$voucherNo',
  '$voucherDate',
  '$hotelName',
  ...
  if($result>0){
    ...
    echo '<script type="text/javascript" >M.toast({html: "voucher Amended successfully"});</script>';
    echo '<script type="text/javascript">window.open("core/printer.php?id='.$id_h.' ","_blank");</script>';
      }
      else{

        echo '<script type="text/javascript" >M.toast({html: "Error amending this voucher"});</script>';
      }
  }
  else{
    echo"error sshit";
  ...
  <form action="Amends.php" method="post" id="newVoucherForm">
    <section style="padding-top: 50px;">
      <div class="container">
        <div class="row">
          <div >
            <h3 class="mb-5 text-warning display-4">Amend Voucher</h3>

            <div class="row">

              <div class="col-md-3 form-group">
                <label for="hotelName">Voucher No</label>
                <select name="voucherNo" id="voucherNo" class="form-control">
                  <option>Select No</option>
                  <?php 
                  $query="select distinct voucherNo from voucherh where status='pending' ";
            ...
            <!-- <div class="col-md-2 form-group">
              <label >Id</label><br>
              <input type="text" name="idh" id="idh" readonly="" class="form-control" >
            </div> -->
             <div class="col-md-3 form-group">
              <label for="receivedFrom">Received From</label>
              <input type="text" readonly name="receivedFrom" id="receivedFrom" class="form-control">
            </div>
            ...
            <div class="col-md-2 form-group">
              <label >Amends count</label><br>
              <input type="text" readonly name="amendCount" id="amendCount" class="form-control">
            </div>
          ...
          <div class="row">
              ...
              <input type="text" id="gusetName"  class="form-control" name="guestName" autocomplete="off" required>
              </div>
