...
<body>
  ...
  <section class="">
    <div class="container-fluid pt-5 mt-5 p-5" style="margin-left: 250px">
      <div class="row">
        <div >
  ...
  if(isset($_POST['hotelName'])):
    ...
    $query="SELECT `ID_H`, `voucherNo`, `voucherDate`, `hotelName`, `status`, `AmendCount`, `conformationCode`, `receivedFrom`, `receivedCode`, `nationalty`, `guestName` FROM `voucherh` WHERE hotelName like '%$hotelName' 
    and receivedfrom like '%$receivedFrom' 
    and nationalty like '%$nationality' 
